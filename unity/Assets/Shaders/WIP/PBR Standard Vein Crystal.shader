    ...
    SubShader {
        ...
        Pass {
            ...
            v2f vert(appdata_full v, uint instanceID : SV_InstanceID, uint vertexID : SV_VertexID)
            {
                ...
                o.worldPos.xyz = worldVPos; //o7 //tex6
            ...
            fout frag(v2f inp)
            {
                fout o;
                  ...
                  float4 grabScreenPos = inp.grabScreenPos.xyzw;
                  ...
                  float3 lightColor = atten * sunsetColor; //r7.xyz
                  ...
                  float3 headlampLight = calculateLightFromHeadlamp(_Global_PointLightPos, upDir, lightDir, worldNormal, 5.0, 20.0, false, 1.0); //r3.xyz
                  ...
                  float3 ambientLight = lerp(ambientSpecularLight, ambientSpecularLuminance, float3(0.5, 0.5, 0.5)); //r5.xzw
                  ...
                  float3 finalColor = headlampLightColor * pow(1.0 - metallicLow, 0.6) + specularColor + ambientLight; //r1.xzw
