/* Last tested: DSP 0.10.28.21308 */
Shader "VF Shaders/Batching/Cargo Instancing REPLACE" {
    Properties {
        ...
        _IncArrowColor ("Inc Arrow Color", Color) = (1,1,1,1)
        ...
        Pass {
            ...
            */
            ...
            fout frag(v2f i)
            {
                ...
                uint effectiveInc = floor(0.0001 + (inc / stack)); //r1.z
